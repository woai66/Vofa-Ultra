...
describe("工作区文件", () => {
  ...
  it("以严格的 v12 格式往返校验模式、模拟器及完整工作区配置", () => {
  ...
  it("严格校验 v12 姿态字段、快捷命令、接收配置及派生通道引用", () => {
    const profile = createWorkspaceProfile(
      "姿态工作区",
      createDefaultWorkspaceConfig("simulator"),
      "attitude",
  ...
  it.each([
    ...
    ["未知版本", { format: "vofa-ultra.workspace", schemaVersion: 13 }],
