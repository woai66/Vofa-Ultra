...
[内置协议贡献契约](protocols.md)、[VUCAP 捕获文件格式](capture-format.md)和[架构说明](architecture.md)。
...
左侧导航依次为“连接”“通道”“处理”“自动化”“记录”“工作区”“设置”。再次点击当前导航项可收起侧栏。
...
“导出终端记录”只导出这些有界的当前可见记录，因此不能替代无损捕获；需要保留完整原始字节时使用 `.vucap`
录制。“清空终端”不会清除波形或捕获文件。
